...
<div id="wrapper">
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		...
		<ul class="nav navbar-top-links navbar-right">
            ...
            <li><a href="{{url('info')}}" class="@if(Request::segment(1)=="info") active @endif">{{trans('app.info')}}</a></li>
			<li class="dropdown">
...
@if (Session::has('custom_notify'))
	<script type="text/javascript">MT.showNotification("","{{ Session::get('custom_notify') }}","lemon")</script>
@endif
