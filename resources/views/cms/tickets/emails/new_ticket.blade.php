                                ...
                                <tr>
                                    <td class="wrapper last">
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <h1>{{$titleTicket}}: {{$ticket}}</h1>
                                                    <p class="lead">{{$contentTicket}}</p>
                                                </td>
                                                <td class="expander"></td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td class="wrapper last">
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="panel">
                                                    <p>Some cool frase. <a href="#">Click it! »</a></p>
                                                </td>
                                                <td class="expander"></td>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="six columns">
                                            <tr>
                                                <td class="last right-text-pad">
                                                    ...
                                                    <p>Email: <a href="/cdn-cgi/l/email-protection#f39b80969f979c9db38781929d879c81dd909c9e"><span class="__cf_email__" data-cfemail="274f54424b43484967535546495348550944484a">[email&#160;protected]</span><script cf-hash='f9e31' type="text/javascript">
